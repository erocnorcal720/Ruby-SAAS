...
def create_visitor
  @visitor ||= { :name => "Testy McUserton", :email => "example@example.com",
    :password => "changeme", :password_confirmation => "changeme", :role => "basic" }
end
...
def sign_up
  delete_user
  visit '/users/sign_up/?plan=basic'
...
When /^I follow the subscribe for basic path$/ do
  visit '/users/sign_up/?plan=basic'
end
...
Then /I should be on the new basic user registration page$/ do
  current_path_with_args.should == '/users/sign_up/?plan=basic'
end
