...
describe User do
  ...
  describe "#update_plan" do
    before do
      ...
      @role1 = FactoryGirl.create(:role, name: "basic")
      @role2 = FactoryGirl.create(:role, name: "premiere")
      @user.add_role(@role1.name)
    end

    it "updates a users role" do
      @user.roles.first.name.should == "basic"
      @user.update_plan(@role2)
      @user.roles.first.name.should == "premiere"
    end
  ...
  describe ".update_stripe" do
    ...
    context "with a non-existing user" do
      ...
      before do
        ...
        @role = FactoryGirl.create(:role, name: "basic")
